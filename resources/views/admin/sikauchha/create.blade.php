...
@section('title', 'Create New Ohm Sikauchha - Ohm Pharmaceuticals')
    ...
    <div class="content">
        <div class="card container-fluid mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Create Ohm Sikauchha</h5>
            ...
            <div class="card-body p-0">
                <form class="row" method="POST" action="{{ route('sikauchha.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-9">
