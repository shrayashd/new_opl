...
@section('title', 'Edit ' . $video->name . ' - Ohm Pharmaceuticals')
    ...
    <div class="content">
        <div class="card container-fluid mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Edit Videos - {{ $video->name }}</h5>
            ...
            <div class="card-body p-0">
                <form class="row mb-3" method="POST" action="{{ route('videos.update', $video->id) }}"
                        ...
                        <div class="card card-body main-description shadow br-8 p-4">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control br-8 @error('link') is-invalid @enderror" type="text"
                                    name="link" value="{{ old('link', $video->link) }}" placeholder="Enter Url">
                                @error('link')
                                    <div class="invalid-feedback" style="display: block;">
                                        {{ $message }}
                                    </div>
