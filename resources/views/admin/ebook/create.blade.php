...
@section('title', 'Create New Ebook - Ohm Pharmaceuticals')
    ...
    <div class="content">
        <div class="card container-fluid mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Create Ohm ebook</h5>
            ...
            <div class="card-body p-0">
                <form class="row" method="POST" action="{{ route('ebook.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-9">
                        <div class="card card-body main-description shadow br-8 p-4">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="custom-file">
                                    <input class="dropify @error('image') is-invalid @enderror" id="file"
                                        data-show-remove="false" type="file" name="file">
                                    @error('image')
                                        <div class="invalid-feedback" style="display: block;">
                                            {{ $message }}
                                        </div>
